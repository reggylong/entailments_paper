...
\rl{Need to mention that relations don't increase that much relative
to the number of triples extracted}.
...
as \reffig{triples} shows,
This suggests \rl{FINISH THIS}
